...
namespace Voxell.Jobx
{
  public sealed class Float3MinScanJob : System.IDisposable
  {
    ...
    private HillisSteeleFloat3MinScanJob minScanJob;

    public Float3MinScanJob(ref NativeArray<float3> na_values)
    {
      ...
      this.minScanJob = new HillisSteeleFloat3MinScanJob(
        ref na_values, ref na_prevValues
      );
    }

    /// <summary>Perform a Hillis Steele inclusive max scan.</summary>
    public void InclusiveMinScan()
    {
      Profiler.BeginSample("InclusiveMinScan");
      JobHandle jobHandle;
    ...
    private struct HillisSteeleFloat3MinScanJob : IJobParallelFor
    {
      public int offset;
      ...
      public HillisSteeleFloat3MinScanJob(
      ...
      public void Execute(int index)
      {
        ...
        if (sumIdx >= 0) na_values[index] = math.min(na_values[index], na_prevValues[sumIdx]);
      }
    }
